...
<div class="container">
  ...
  if(isset($departSum) && !empty($departSum)){
    ...
    echo "<tr><th>Flight ID</th> <th>Flight Date</th> <th>From</th>
          <th>To</th><th>Fee</th></tr>";
    echo "<tr><td style='width:20%'>".$departSum[0]->flightID."</td>";
    echo "<td style='width:25%'>".$departSum[0]->flightDate."</td>";
    echo "<td style='width:20%'>".$departSum[0]->from."</td>";
    echo "<td style='width:20%'>".$departSum[0]->to."</td>";
  ...
  if(isset($returnSum) && !empty($returnSum)){
    ...
    echo "<tr><th>Flight ID</th> <th>Flight Date</th> <th>From</th>
          <th>To</th><th>Fee</th> </tr>";
    echo "<tr><td style='width: 20%'>".$returnSum[0]->flightID."</td>";
    echo "<td style='width:25%'>".$returnSum[0]->flightDate."</td>";
    echo "<td style='width:20%'>".$returnSum[0]->from."</td>";
    echo "<td style='width:20%'>".$returnSum[0]->to."</td>";
    echo "<td style='width:15%'>".$returnSum[0]->fee."</td></tr>";
    echo "</table>";
    $sum += $returnSum[0]->fee;
  }
